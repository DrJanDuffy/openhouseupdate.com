        ...
        <div class="prose prose-lg max-w-none">
          ...
          <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
              ...
              <ul class="space-y-2">
                ...
                <li>
                  <a href="/terms-of-service" class="text-blue-600 hover:text-blue-800">
                    Terms of Service
                  </a>
                </li>
              </ul>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
              ...
              <ul class="space-y-2">
                <li>
                  <a href="/search" class="text-blue-600 hover:text-blue-800">
                    Advanced Search
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/this-weekend" class="text-blue-600 hover:text-blue-800">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
              ...
              <ul class="space-y-2">
                ...
                <li>
                  <a href="/services/home-valuation" class="text-blue-600 hover:text-blue-800">
                    Home Valuation
                  </a>
                </li>
                <li>
                  <a href="/services/buyer-services" class="text-blue-600 hover:text-blue-800">
                    Buyer Services
                  </a>
                </li>
                <li>
                  <a href="/services/seller-services" class="text-blue-600 hover:text-blue-800">
                    Seller Services
                  </a>
                </li>
                <li>
                  <a href="/services/market-analysis" class="text-blue-600 hover:text-blue-800">
                    Market Analysis
                  </a>
                </li>
              </ul>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
              ...
              <ul class="space-y-2">
                ...
                <li>
                  <a href="/open-houses-for-sale/800k-1m" class="text-blue-600 hover:text-blue-800">
                    $800K - $1M
                  </a>
                </li>
                <li>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
              ...
              <ul class="space-y-2">
                ...
                <li>
                  <a href="/neighborhoods/enterprise" class="text-blue-600 hover:text-blue-800">
                    Enterprise
                  </a>
                </li>
              </ul>
            ...
            <div class="bg-gradient-to-r from-blue-600 to-green-600 rounded-lg shadow-lg p-6 text-white">
              ...
              <ul class="space-y-2">
                ...
                <li>
                  <a href="/services/home-valuation" class="text-white hover:text-gray-200">
                    Free Home Valuation
                  </a>
                </li>
                <li>
                  <a href="/search" class="text-white hover:text-gray-200">
                    Search Properties
                  </a>
                </li>
                <li>
                  <a href="/this-weekend" class="text-white hover:text-gray-200">
          ...
          <div class="mt-12 bg-gray-50 rounded-lg p-8">
            ...
            <p class="text-gray-600 mb-4">
              This sitemap provides a comprehensive overview of all pages available on Open House
              Update. Our website is designed to help you find your perfect home in Las Vegas with
              the guidance of Dr. Janet Duffy, a licensed real estate professional.
            </p>
            <div class="grid md:grid-cols-2 gap-6">
              <div>
                <h3 class="text-lg font-semibold text-gray-900 mb-2">Real Estate Services</h3>
                <p class="text-gray-600 text-sm">
                  Professional buying and selling services, home valuations, and market analysis for
                  the Las Vegas area.
                </p>
              </div>
              <div>
                ...
                <p class="text-gray-600 text-sm">
                  Specialized knowledge of Las Vegas neighborhoods, market trends, and community
                  amenities.
                </p>
              </div>
            </div>
  ...
  meta: [
    {
      name: 'description',
      content:
        'Complete sitemap for Open House Update - Las Vegas real estate services. Find all pages, services, and property search options.',
    },
    {
      name: 'robots',
