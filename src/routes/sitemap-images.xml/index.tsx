...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
  ...
  <url>
    <loc>https://openhouseupdate.com</loc>
    <lastmod>${currentDate}</lastmod>
    <changefreq>daily</changefreq>
    <priority>1.0</priority>
    <image:image>
      <image:loc>https://openhouseupdate.com/images/og-default.jpg</image:loc>
    ...
    <image:image>
      <image:loc>https://openhouseupdate.com/images/og-homepage.jpg</image:loc>
      <image:caption>Las Vegas Real Estate Homepage</image:caption>
      <image:title>Find Your Dream Home in Las Vegas</image:title>
    </image:image>
    <image:image>
      <image:loc>https://openhouseupdate.com/images/logo.png</image:loc>
      <image:caption>Open House Update Logo</image:caption>
      <image:title>Open House Update Brand</image:title>
    </image:image>
  </url>
  <url>
    <loc>https://openhouseupdate.com/about</loc>
    <lastmod>${currentDate}</lastmod>
    <changefreq>monthly</changefreq>
    <priority>0.8</priority>
    <image:image>
      <image:loc>https://openhouseupdate.com/images/dr-janet-duffy.jpg</image:loc>
