...
export const openGraphConfigs = {
  homepage: (): DocumentMeta[] => createOpenGraphMeta({
    title: 'Las Vegas Real Estate - Find Your Dream Home | Open House Update',
    description: 'Professional real estate services in Las Vegas. Search thousands of properties, get home valuations, and work with Dr. Janet Duffy for expert guidance.',
    type: 'website',
  ...
  homeValuation: (): DocumentMeta[] => createOpenGraphMeta({
    title: 'Free Home Valuation - Las Vegas Real Estate | Dr. Janet Duffy',
    description: 'Get a free, accurate home valuation for your Las Vegas property. Professional market analysis and property assessment from Dr. Janet Duffy.',
    type: 'website',
  ...
  buyerServices: (): DocumentMeta[] => createOpenGraphMeta({
    title: 'Buyer Services - Expert Home Buying Support | Dr. Janet Duffy',
    description: 'Professional buyer services in Las Vegas. Complete support from property search to closing with Dr. Janet Duffy, your trusted real estate agent.',
    type: 'website',
    ...
    articleTag: ['buyer services', 'home buying', 'property search', 'real estate agent', 'Las Vegas'],
  }),

  sellerServices: (): DocumentMeta[] => createOpenGraphMeta({
    title: 'Seller Services - Expert Home Selling Support | Dr. Janet Duffy',
    description: 'Professional seller services in Las Vegas. Complete support from listing to closing with Dr. Janet Duffy, your trusted real estate agent.',
    type: 'website',
    ...
    articleTag: ['seller services', 'home selling', 'property listing', 'real estate agent', 'Las Vegas'],
  }),

  marketAnalysis: (): DocumentMeta[] => createOpenGraphMeta({
    title: 'Market Analysis - Las Vegas Real Estate Trends | Dr. Janet Duffy',
    description: 'Comprehensive market analysis for Las Vegas real estate. Get insights on trends, pricing, and investment opportunities.',
    type: 'website',
    ...
    articleTag: ['market analysis', 'real estate trends', 'Las Vegas market', 'investment', 'pricing'],
  }),

  about: (): DocumentMeta[] => createOpenGraphMeta({
    title: 'About Dr. Janet Duffy - Las Vegas Real Estate Agent',
    description: 'Learn about Dr. Janet Duffy, your trusted Las Vegas real estate agent. Professional service, local expertise, and personalized guidance.',
    type: 'profile',
  ...
  contact: (): DocumentMeta[] => createOpenGraphMeta({
    title: 'Contact Dr. Janet Duffy - Las Vegas Real Estate Agent',
    description: 'Contact Dr. Janet Duffy for professional real estate services in Las Vegas. Get expert guidance for buying or selling your home.',
    type: 'website',
  ...
  search: (): DocumentMeta[] => createOpenGraphMeta({
    title: 'Property Search - Find Las Vegas Real Estate | Open House Update',
    description: 'Search thousands of Las Vegas properties with our advanced real estate search. Find your perfect home with Dr. Janet Duffy.',
    type: 'website',
  ...
  map: (): DocumentMeta[] => createOpenGraphMeta({
    title: 'Las Vegas Real Estate Map - Interactive Property Search',
    description: 'Explore Las Vegas properties on our interactive map. Find homes by location with detailed neighborhood information.',
    type: 'website',
    url: 'https://openhouseupdate.com/map',
    image: 'https://openhouseupdate.com/images/og-map.jpg',
    imageAlt: 'Las Vegas Real Estate Map',
    articleTag: ['real estate map', 'Las Vegas properties', 'interactive map', 'neighborhood search'],
  }),

  neighborhoods: (neighborhood: string): DocumentMeta[] => createOpenGraphMeta({
  ...
  openHouses: (priceRange?: string): DocumentMeta[] => createOpenGraphMeta({
    title: priceRange 
  ...
  blog: (): DocumentMeta[] => createOpenGraphMeta({
    title: 'Las Vegas Real Estate Blog - Market Insights & Tips',
    description: 'Stay informed with the latest Las Vegas real estate market insights, tips, and trends from Dr. Janet Duffy.',
    type: 'website',
  ...
  faq: (): DocumentMeta[] => createOpenGraphMeta({
    title: 'Frequently Asked Questions - Las Vegas Real Estate',
    description: 'Get answers to common real estate questions about buying and selling homes in Las Vegas with Dr. Janet Duffy.',
    type: 'website',
    url: 'https://openhouseupdate.com/faq',
    image: 'https://openhouseupdate.com/images/og-faq.jpg',
    imageAlt: 'Real Estate FAQ - Las Vegas',
    articleTag: ['real estate FAQ', 'home buying questions', 'home selling questions', 'Las Vegas'],
  }),
};
