    ...
    <div class={`${getVariantStyles()} ${className}`}>
      ...
      {!isExpanded.value ? (
        <div class="text-center">
          <div class="cta-pulse mb-4">
            ...
            <p class="text-gray-600 mb-4">
              ...
              Get an instant estimate plus a detailed report from Dr. Janet Duffy.
            </p>
            <button
        ...
        <div>
          ...
          <div class="text-center">
            <p class="text-gray-600 mb-4">
              Click below to access our professional home valuation tool powered by RealScout. 
              Get an instant estimate and detailed market analysis.
            </p>
            <button
              onClick$={openRealScoutWidget}
              class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-200 w-full"
